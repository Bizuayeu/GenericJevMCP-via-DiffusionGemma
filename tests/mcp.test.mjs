...
test('MCP returns typed timing and the canonical display without rewriting',()=>{
 const value={answers:{complexity:null},metrics:{complexity:null},timing:{total_seconds:.882,decision_seconds:.106},display:'所要時間（全体）: 0.882 秒\n判定時間: 0.106 秒'};
 ...
 assert.throws(()=>toolResult(JSON.stringify({...value,metrics:{complexity:{confidence:1,entropy_nats:0}}})));
